...
background = pygame.image.load("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\Coin.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P, Enemies):
        pygame.mixer.Sound("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\crash.wav").play()
        time.sleep(0.5)
        disp.fill((255,0,0))
    ...
    if pygame.sprite.spritecollideany(P, Coins):
        pygame.mixer.Sound("\\Users\sotas\OneDrive\Рабочий стол\pp2_spring\labs\lab8\racer\bell.wav").play()
        pygame.display.update()
        C.disappear()
